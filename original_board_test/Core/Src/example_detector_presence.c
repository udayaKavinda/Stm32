...
#define DEFAULT_PRESET_CONFIG PRESENCE_PRESET_CONFIG_SHORT_RANGE
...
static void set_config(acc_detector_presence_config_t *presence_config, presence_preset_config_t preset)
{
	switch (preset)
	{
		...
		case PRESENCE_PRESET_CONFIG_SHORT_RANGE:
			acc_detector_presence_config_start_set(presence_config, 0.01f);
			acc_detector_presence_config_end_set(presence_config, 0.15f);
...
//			acc_detector_presence_config_inter_frame_idle_state_set(presence_config, ACC_CONFIG_IDLE_STATE_DEEP_SLEEP);
			acc_detector_presence_config_sweeps_per_frame_set(presence_config, 26);
			acc_detector_presence_config_frame_rate_set(presence_config, 50.0f);
			...
			acc_detector_presence_config_intra_detection_threshold_set(presence_config, 2.0f);
